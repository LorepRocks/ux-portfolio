export const projectsList = [
    {
        ...
        mockups: [
            {id: 1, name: 'homepage mobile', url: '/ichoose/mockup-homepage.png', alt: 'iChoose app mockup homepage'},
            {id: 2, name: 'restaurant page mobile', url: '/ichoose/mockup-restaurant-page.png', alt: 'iChoose app mockup restaurant page'},
            {id: 3, name: 'reservation summary mobile', url: '/ichoose/mockup-reservation-summary.png', alt: 'iChoose app mockup reservation summary'},
            {id: 4, name: 'restaurant list mobile', url: '/ichoose/mockup-restaurant-list.png', alt: 'iChoose app mockup restaurant list'},
            {id: 5, name: 'reservation confirm mobile', url: '/ichoose/mockup-reservation-confirm.png', alt: 'iChoose app mockup reservation confirm'}
    ...
    },
    {
        ...
        research_study: null,
        paper_design: {url : '/bookNotes/paper-design2.png', alt: 'bookNotes app paper design'},
        wireFrames: [
            {id: 1, name: 'homepage mobile', url: '/bookNotes/wireframe-homepage.png', alt: 'bookNotes app wireframe homepage'},
            {id: 2, name: 'homepage web', url: '/bookNotes/wireframe-web-homepage.png', alt: 'bookNotes app web wireframe homepage'},
            {id: 3, name: 'books mobile', url: '/bookNotes/wireframe-books.png', alt: 'bookNotes app wireframe books'},
            {id: 4, name: 'books web', url: '/bookNotes/wireframe-web-books.png', alt: 'bookNotes app wireframe web books'},
        ],
        user_testing_results: null,
        storyBoards: null,
        mockups: [
    ...
    },
    {
        ...
        wireFrames: [
            ...
            {id: 3, name: 'event agenda', url: '/localHub/wireframe-event-agenda.png', alt: 'LocalHub app wireframe event agenda'},
        ...
        storyBoards: null,
        mockups: [
            {id: 1, name: 'homepage mobile', url: '/localHub/mockup-homepage.png', alt: 'LocalHub app mockup homepage'},
            {id: 2, name: 'coming events mobile', url: '/localHub/mockup-coming-events.png', alt: 'LocalHub app mockup coming events'},
            {id: 3, name: 'event agenda mobile', url: '/localHub/mockup-event-agenda.png', alt: 'LocalHub app mockup event agenda'},
            {id: 4, name: 'event detail mobile', url: '/localHub/mockup-event-detail.png', alt: 'LocalHub app mockup event detail'},
            {id: 5, name: 'search page mobile', url: '/localHub/mockup-search.png', alt: 'LocalHub app mockup search page'},
        ...
        sitemap: {url: '/localHub/sitemap.png', alt: 'LocalHub app sitemap'},
